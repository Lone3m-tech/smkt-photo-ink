...
这不是多风格工具。它以固定处理把画面中的人物、动物、物件与背景一起重绘为竖版 3:5。来源图比例不同时，画面以安静的场景延展重新适配，只裁掉无定义意义的空白边缘；主体、姿势、相对位置、关键场景锚点与原图主色、局部色、白平衡、冷暖关系、相对明度和饱和度都会保留。
...
- 重点保留：主体的可辨认特征、服装或动物花纹、场景锚点、主要构图，以及来源图的主色、局部色、白平衡、冷暖关系、相对明度和饱和度；不会为了画幅裁掉、删除、复制或替换主体。
